namespace CustomBatteries.API
{
    ...
    /// <summary>
    /// A simple service to allow other mods to use CustomBatteries to quickly add in their own modded batteries.
    /// </summary>
    public interface ICustomBatteriesService
    {
        ...
        /// </returns>
        /// <exception cref="InvalidOperationException">This method must be invoked before CustomBatteries handles its own patching.</exception>
