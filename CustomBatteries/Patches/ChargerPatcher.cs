...
namespace CustomBatteries.Patches
{
    internal static class ChargerPatcher
    {
        internal static void Patch(Harmony harmony)
        {
            ...
            MethodInfo chargerPatcherOnEquipPostfixMethod = AccessTools.Method(typeof(ChargerPatcher), nameof(ChargerPatcher.OnEquipPostfix));
