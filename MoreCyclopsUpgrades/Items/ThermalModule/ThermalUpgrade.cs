namespace MoreCyclopsUpgrades.Items.ThermalModule
{
    ...
    internal class ThermalUpgrade : StackingGroupHandler
    {
        ...
        internal const int MaxThermalChargers = 6;
        ...
        public ThermalUpgrade(TechType thermalUpgradeMk2, SubRoot cyclops) : base(cyclops)
        {
            OnClearUpgrades += () =>
            {
            ...
            StackingUpgradeHandler tier1 = CreateStackingTier(TechType.CyclopsThermalReactorModule);
            tier1.IsAllowedToAdd += (Pickupable item, bool verbose) =>
            {
                return this.TotalCount < MaxThermalChargers;
            };

            StackingUpgradeHandler tier2 = CreateStackingTier(thermalUpgradeMk2);
            ...
            {
                ErrorMessage.AddMessage(CyclopsThermalChargerMk2.MaxThermalReached());
            };
        }
